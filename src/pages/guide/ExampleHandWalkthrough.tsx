...
const STEPS: StepData[] = [
  ...
  },
  {
    ...
    lines: [
      ...
      'BB はチェックし、あなたはベット。BB はこの時点でペアもドローも無いものの、あなたのベットをブラフの可能性も疑い、様子を見るためにコールしてターンに進みます。',
    ],
  },
  {
    title: 'ターン',
  ...
  },
  {
    ...
    lines: [
      ...
      'あなたはボードの K♥ と合わせて K のペア + A キッカー、BB はボードの Q♣ と合わせて Q のペア。あなたの手が上回り、ポットを獲得します。',
    ],
  },
];
